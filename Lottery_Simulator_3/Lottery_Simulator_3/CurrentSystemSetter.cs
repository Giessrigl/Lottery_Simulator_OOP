...
{
    class CurrentSystemSetter : OptionsMenu, IExecuteable
    {
        public CurrentSystemSetter(string title, char abbreviation, char[] uniqueChars, Lottery lotto) : base(title, abbreviation, uniqueChars, lotto)// Constructor
        {
